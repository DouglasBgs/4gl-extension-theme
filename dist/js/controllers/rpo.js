...
class RpoController {
    static download(pathToRpo) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = new config_1.ConfigModel(pathToRpo);
            const build = yield servers_1.Servers.selectBuild();
            if (!build) {
                return;
            }
            let rpoRede;
            ...
            const selecionado = yield utils_1.Utils.selecionaDados(options, 'Selecione a versão do Rpo que deseja fazer o download');
